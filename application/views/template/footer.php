<div id="footer" class="footer">
	<div class="container">
		...
		Copyright &copy;  <?php echo date("Y") ?> Kecamatan Kalimanah | Made with <span i class="fa fa-heart" style="color:#DC3545"> </span> by Bhinneka Software in SMKN 1 Purbalingga | Distributed by <a href="https://blogbugabagi.blogspot.com" target="_blank" rel="noopener noreferrer">BlogBugaBagi</a>
	</div>
</div>
</main>
<?php $i = $ig->row_array()?>
